export default function Loading() {
  return (
    <div className="flex flex-col gap-6 animate-pulse">
      <div>
        <div className="h-7 w-24 bg-[#E2E8F0] rounded-lg mb-2" />
        <div className="h-4 w-64 bg-[#F1F5F9] rounded-lg" />
      </div>
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-xl overflow-hidden shadow-sm">
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="px-6 py-4 border-b border-[#F8FAFC] flex items-center gap-8">
            <div className="h-3 w-16 bg-[#F1F5F9] rounded font-mono" />
            <div className="flex flex-col gap-1.5 flex-1">
              <div className="h-3 w-32 bg-[#F1F5F9] rounded" />
              <div className="h-2.5 w-24 bg-[#F8FAFC] rounded" />
            </div>
            <div className="h-3 w-24 bg-[#F8FAFC] rounded" />
            <div className="h-6 w-16 bg-[#F1F5F9] rounded-md" />
            <div className="h-5 w-14 bg-[#F1F5F9] rounded-md" />
